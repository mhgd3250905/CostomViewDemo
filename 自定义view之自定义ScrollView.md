...
![效果](CostomViewDemo/img/自定义控件之组合控件.gif)
...
- 引用布局
  ...
  ![效果](CostomViewDemo/img/customView.png)
...
- 定义属性
    ...
    ![attrs.xml](CostomViewDemo/img/attrpath.png)
...
- 使用属性
  ...
  ![attr2](CostomViewDemo/img/attr2.png)

  ![attr3](CostomViewDemo/img/attr3.png)
